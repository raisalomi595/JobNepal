      ...
      <section className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto mb-14">
            {[
              { number: "10,000+", label: "Active Jobs", desc: "Listed across all categories" },
              { number: "50,000+", label: "Happy Candidates", desc: "Successfully placed in jobs" },
              { number: "2,500+", label: "Partner Companies", desc: "Trust us for recruitment" },
              { number: "12+", label: "Years of Service", desc: "Serving Nepal since 2014" },
            ].map((stat) => (
              <div key={stat.label} className="bg-white rounded-2xl p-5 md:p-6 text-center border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 mx-auto mb-2 bg-[#0261a6]/10 rounded-xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#0261a6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <div className="space-y-3">
                  {[
                    "Free job search and application for candidates",
                    "Verified employers and genuine vacancies",
