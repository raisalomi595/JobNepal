          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm text-[#b3b3b3]">
                  {["Home", "About Us", "Advertise", "Contact Us", "FAQ"].map((link) => (
...
Kathmandu, Nepal</span>
              ...
              <div className="flex gap-2 mt-4">
                {[
                  ...
                  <a key={social.name} href="#" className="w-[30px] h-[30px] rounded-full bg-[#989898] hover:bg-[#777] flex items-center justify-center transition-colors" aria-label={social.name}>
